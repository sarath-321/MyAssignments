...
public class ServiceNowApplication {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		sh1.findElementByXPath("//input[@placeholder='Filter']").sendKeys("Service catalog");
		
		Shadow sh2 = new Shadow(driver);
		sh2.setImplicitWait(30);
		sh2.findElementByXPath("//mark[text()='Service Catalog']").click();
		
		Shadow sh3 = new Shadow(driver);
		sh3.setImplicitWait(30);
		WebElement frame = sh3.findElementByXPath("//iframe[@id='gsft_main']");
